        ...
        <div class="container">
            ...
            <div class="category-header">
                ...
                <div class="category-filter">
                    ...
                    <el-select v-model="helmetType" placeholder="类型选择" @change="handleFilterChange">
...
const fetchProducts = async () => {
    ...
    try {
        const params = {
            ...
            sort: sortBy.value,
            type: helmetType.value,
            priceRange: priceRange.value || undefined
        }
        console.log('Request params:', params)
        const response = await productAPI.getProductsByCategory('头盔', params)
